...
namespace AttendanceCheck.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        private readonly AttendanceCheckDbContext _attendanceCheckDbContext;
        ...
        public RegisterModel(
            ...
            AttendanceCheckDbContext attendanceCheckDbContext)
        {
            _userManager = userManager;
            _signInManager = signInManager;
            _logger = logger;
            _emailSender = emailSender;
            _attendanceCheckDbContext = attendanceCheckDbContext;
        }
